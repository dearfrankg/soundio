...
class SongCards extends Component {
  ...
  componentWillReceiveProps (nextProps) {
    ...
    || paddingBottom !== this.state.paddingBottom         // eslint-disable-line
    || start !== this.state.start                         // eslint-disable-line
    || end !== this.state.end) {                          // eslint-disable-line
      this.setState({
        end,
        paddingBottom,
        paddingTop,
